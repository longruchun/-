...
public class BaseDao {
	public final static String DRIVER = "oracle.jdbc.OracleDriver"; // 数据库驱动

	public final static String URL = "jdbc:oracle:thin:@localhost:1521:epet"; // url

	public final static String DBNAME = "epet"; // 数据库用户名

	public final static String DBPASS = "1"; // 数据库密码
